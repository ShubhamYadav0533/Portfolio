...
const FeaturedProjects: React.FC = () => {
  ...
  return (
    <section className="container mx-auto py-32 px-6">
      ...
      >
        <div>
          <p className="text-accent-primary font-bold text-sm tracking-[0.3em] uppercase mb-3">Portfolio</p>
          <h2 className="text-5xl md:text-7xl font-black tracking-tighter text-text-primary uppercase">
        ...
        <Link
          to="/projects"
          className="inline-flex items-center gap-3 text-text-secondary hover:text-accent-primary font-bold uppercase tracking-widest text-sm transition-colors group"
        >
