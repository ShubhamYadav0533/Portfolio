...
const Projects: React.FC = () => {
 ...
 >
 <span className="text-accent-primary text-[10px] font-black tracking-[0.4em]">Portfolio</span>
 </motion.div>
 ...
 className={`px-8 py-3 rounded-2xl font-black text-[10px] tracking-[0.2em] border transition-all duration-300 active:scale-95 ${
 filter === tag
 ...
 <a
 href={project.link}
 className="flex items-center gap-2 text-text-primary font-black text-[10px] tracking-widest group/btn"
 >
