...
const Education: React.FC = () => {
 ...
 >
 <span className="text-accent-primary text-[10px] font-black tracking-[0.4em]">Milestones</span>
 </motion.div>
 ...
 >
 <span className="text-accent-primary font-black text-xs tracking-widest mb-4 block">
 {item.year}
 </span>
