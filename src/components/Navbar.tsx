      ...
      >
        ...
        <Link to="/" className="group flex items-center gap-2">
          ...
          <div className="flex flex-col -gap-1">
            ...
            <span className="text-[10px] font-bold text-text-tertiary uppercase tracking-[0.2em]">Creative Dev</span>
          </div>
        </Link>
            ...
            return (
              <div key={link.label} className="relative px-4 py-2">
                {link.href.startsWith('/#') ? (
                  <a
                    href={link.href}
                    className="relative z-10 text-[11px] font-black uppercase tracking-[0.15em] text-text-secondary hover:text-accent-primary transition-colors duration-300"
                  >
                    {link.label}
                  </a>
                ) : (
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            to="/#contact"
            className="hidden md:flex px-6 py-2.5 rounded-xl bg-text-primary text-bg-primary text-[11px] font-black uppercase tracking-widest hover:bg-accent-primary hover:scale-105 transition-all duration-300 active:scale-95"
          >
            Let's Talk
          </Link>
